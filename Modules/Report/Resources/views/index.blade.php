                ...
                <form action="{{ url('report/print') }}" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <div class="form-material">
                                <input type="text" class="js-flatpickr form-control"
                                    id="example-material-flatpickr-default" name="tanggal_mulai" data-allow-input="true"
                                    @if (old('tanggal') != '') value="{{ old('tanggal_mulai') }}" @else value="{{ date('Y-m-d', strtotime('-7 days')) }}" @endif>
                        ...
                        <div class="col-md-3">
                            <div class="form-material">
                                <input type="text" class="js-flatpickr form-control"
                                    id="example-material-flatpickr-default2" name="tanggal_selesai" data-allow-input="true"
                                    @if (old('tanggal') != '') value="{{ old('tanggal_selesai') }}" @else value="{{ date('Y-m-d') }}" @endif>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3 div_agen_kategori">
                            <div class="form-material">
                                <select class="js-select2 form-control" id="example2-select21" name="id_kategori"
                                    style="width: 100%;" data-placeholder="Pilih kategori" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                        ...
                        <div class="col-md-3 div_nama_agen">
                            <div class="form-material">
                                <select class="js-select2 form-control" id="example2-select22" name="id_agen"
                                    style="width: 100%;" data-placeholder="Pilih agen" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <option value="pontianak">AGEN PONTIANAK</option>
                                    <option value="non-pontianak">AGEN NON PONTIANAK</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-material">
                                <select class="js-select2 form-control" id="example2-select222" name="id_barang"
            ...
            <div class="block-content block-content-full">
                <form action="{{ url('report/print/stok') }}" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <div class="form-material">
                                <select class="js-select2 form-control select_bulan" name="bulan"
                                    data-placeholder="Pilih bulan" required>
                                    <option></option>
                                    <option value="01" @if ($bulan == '01') selected @endif>Januari
                                    </option>
                                    <option value="02" @if ($bulan == '02') selected @endif>Februari
                                    </option>
                                    ...
                                    <option value="08" @if ($bulan == '08') selected @endif>Agustus
                                    </option>
                                    <option value="09" @if ($bulan == '09') selected @endif>September
                                    </option>
                        ...
                        <div class="col-md-3">
                            <div class="form-material">
                                <select class="js-select2 form-control select_tahun" name="tahun"
                                    data-placeholder="Pilih tahun" required>
                                    <option></option>
                                    @for ($i = date('Y'); $i >= date('Y') - 2; $i--)
                                        <option value="{{ $i }}"
                                            @if ($tahun == $i) selected @endif>{{ $i }}
                                        </option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-material">
                                <input type="text" class="form-control" name="koordinator" value="Heri Setiawan"
                                    required>
