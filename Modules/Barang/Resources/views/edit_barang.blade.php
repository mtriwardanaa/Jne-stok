        ...
        <div class="block-content">
            <form id="formWithPrice" action="{{ url('barang/update', $barang['id']) }}" method="post">
                ...
                <div class="form-group row">
                    <div class="col-6">
                        <div class="form-material">
                            <input type="text" class="form-control number price" maxlength="20" id="material-gridf" value="{{ $barang['qty_barang'] }}" name="jumlah_barang" placeholder="Masukkan jumlah barang" required>
