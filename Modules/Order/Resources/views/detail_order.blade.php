                ...
                <div class="block-content">
                        ...
                        <div class="col-md-9">
                            <div class="form-material">
                                <input type="text" class="js-flatpickr form-control"
                                    ...
                                    data-allow-input="true" value="{{ date('Y-m-d', strtotime($data['tanggal'])) }}"
                                    disabled>
                    ...
                    <div class="form-group row">
                        <div class="col-md-9">
                            <div class="form-material">
                                <input type="text" class="js-flatpickr form-control"
                                    value="{{ date('H:i', strtotime($data['tanggal'])) }}" disabled>
                    ...
                    @if (isset($data['kategori']))
                        <div class="form-group row">
                            <div class="col-md-9">
                                <div class="form-material">
                                    <input type="text" class="form-control" value="{{ $data['kategori']['nama'] }}"
                                        disabled>
                    ...
                    @if (!isset($data['kategori']))
                        <div class="form-group row">
                            <div class="col-md-9">
                                <div class="form-material">
                                    <input type="text" class="form-control" value="{{ $data['created_user']['nama'] }}"
                                        disabled>
                        ...
                        <div class="col-md-9">
                            <div class="form-material">
                                <input type="text" class="form-control"
                                    value="{{ strtoupper($data['nama_user_request']) }}" disabled>
                    ...
                    <div class="form-group row">
                        <div class="col-md-9">
                            <div class="form-material">
                                <input type="text" class="form-control"
                                    value="{{ strtoupper($data['created_user']['no_hp']) }}" disabled>
                    ...
                    <div class="block-content block-content-full">
                        <div class="form-group row">
                            <div class="col-md-3">
                                <div class="form-material">
                                    <input type="text" class="form-control" disabled
                                        value="{{ date('d F Y H:i', strtotime($data['tanggal_approve'])) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-material">
                                    <input type="text" class="form-control" disabled
                                        value="{{ $data['approved_user']['divisi']['nama'] }}">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <div class="form-material">
                                        <input type="text" class="form-control" disabled
                                            value="{{ date('d F Y H:i', strtotime($data['tanggal_reject'])) }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-material">
                                        <input type="text" class="form-control" disabled
                                            value="{{ $data['rejected_user']['divisi']['nama'] }}">
                                        <label for="material-text">Divisi</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-material">
                                        <input type="text" class="form-control" disabled
                                            value="{{ strtoupper($data['rejected_text']) }}">
                            ...
                            <div class="block-content">
                                <b>
                                    ...
                                    @if ($data['id_divisi'] == 13 || $data['id_divisi'] == 23)
                                        {{ strtoupper($data['created_user']['nama']) }} telah melakukan pemesanan sebanyak
                                        {{ count($old) }} kali pada bulan {{ $data['bulan'] }}
                                    @else
                                        Divisi {{ strtoupper($data['divisi']['nama']) }} telah melakukan pemesanan sebanyak
                                        {{ count($old) }} kali pada bulan {{ $data['bulan'] }}
                                    @endif
                                    <br><br>
                                    Tanggal pemesanan :
                                    ...
                                    @foreach ($old as $key => $value)
                                        <br>- {{ $value->all }} <a href="{{ url('order/detail', $value->id) }}"
                                            target="__blank" title="Detail pemesanan barang">(Klik disini untuk melihat
                                            detail pemesanan barang)</a>
                                    @endforeach
                                    <br>
                                    <br>
                            </div>
                        ...
                        <tbody>
                            @foreach ($data['details'] as $key => $row)
                                <tr>
                                    ...
                                    <td class="font-w600">{{ number_format($row['qty_barang']) }}
                                        {{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</td>
                                    @if (isset($data['approved_by']))
                                        <td class="font-w600">{{ number_format($row['jumlah_approve']) }}
                                            {{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</td>
                                    @else
                                        @if (Auth::user()->id_divisi != 10)
                                            <td class="font-w600" style="font-style: italic;">NONE</td>
                                        @else
                                            <td class="font-w600">{{ number_format($row['stokBarang']['qty_barang']) }}
                                                {{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</td>
                                        @endif
                                    @endif
                                </tr>
                                        ...
                                        <tbody>
                                            @foreach ($data['details'] as $key => $row)
                                                ...
                                                <tr class="{{ $class }}">
                                                    ...
                                                    <td><b>{{ $row['qty_barang'] }}</b>
                                                        {{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</td>
                                                    <td><b>{{ $row['stokBarang']['qty_barang'] }}</b>
                                                        {{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</td>
                                                    <td>
                                                        <input type="hidden" class="stok_sekarang_{{ $key }}"
                                                            value="{{ $row['stokBarang']['qty_barang'] }}">
                                                        <input type="hidden" name="id_detail_order[]"
                                                            value="{{ $row['id'] }}">
                                                        <div class="input-group" style="width: 50%">
                                                            <input type="text"
                                                                class="form-control number jumlah_barang"
                                                                data-kelas="{{ $key }}"
                                                                id="example-input2-group2{{ $key }}"
                                                                name="jumlah[]" placeholder="Jumlah barang yang diterima"
                                                                required>
                                                            <div class="input-group-append">
                                                                <button type="button"
                                                                    class="btn btn-secondary">{{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <div class="row no-gutters items-push">
                                                    <div class="col-6">
                                                        <label class="css-control css-control-primary css-radio">
                                                            <input type="radio" class="css-control-input distribusi_ya"
                                                                name="distribusi_sales" value="1"
                                                                @if ($data['id_divisi'] == 13) checked @endif>
                                                            <span class="css-control-indicator"></span> Ya
                                                        </label>
                                                        <label class="css-control css-control-danger css-radio">
                                                            <input type="radio"
                                                                class="css-control-input distribusi_tidak"
                                                                name="distribusi_sales" value="0"
                                                                @if ($data['id_divisi'] != 13) checked @endif>
