...
@section('content')
	...
	<form action="{{ url('order/approve/update', $data['id']) }}" method="post" id="formWithPrice">
	@csrf
		<div class="row">
	        <div class="col-md-3">
	            <!-- Static Labels -->
	        ...
	        <div class="col-md-6">
	            ...
	            <div class="block">
	                <div class="block-header block-header-default">
	                    <h3 class="block-title">Detail barang yang akan diapprove</h3>
	                    <div class="block-options">
	                        <button type="button" class="btn-block-option">
	                            <i class="si si-wrench"></i>
	                        </button>
	                ...
	                <div class="block-content">
	                	@foreach ($data['details'] as $key => $row)
		                    <div class="form-group row">
		                    	<div class="col-4">
		                            <div class="form-material">
		                                <input type="text" class="form-control price number" value="{{ $row['stokBarang']['qty_barang'] }}" placeholder="jumlah barang" maxlength="10" required>
		                                <label for="jumlah_barang[]">Stok Sekarang</label>
		                            </div>
		                        </div>
		                        <div class="col-2">
		                            <div class="form-material">
		                                <input type="text" class="form-control" id="satuan_example2-select23" placeholder="satuan barang" value="{{ $row['stokBarang']['stokBarangSatuan']['nama_satuan'] }}">
		                                <label>Satuan</label>
		                            </div>
		                        </div>
		                        <input type="hidden" name="id_details[]" value="{{ $row['id'] }}">
		                        <div class="col-4">
		                            <div class="form-material">
		                                <input type="text" class="form-control number input_jumlah_barang" name="jumlah_approve[]" data-stok="{{ $row['stokBarang']['qty_barang'] }}" placeholder="jumlah approve" maxlength="10" required>
		                                <label for="jumlah_barang[]">Jumlah Approve </label>
		                            </div>
		                        </div>
		                    </div>
		                    <hr style="height:1px; color:#333; background-color:#333;">
